...
from admin_config.services.gamme_parse_storage import get_or_parse_gamme_data
...
def build_project_kpi_data(project, progress_callback=None):
    from admin_config.models import StepValidation
...
def _ev_result_rows(occurrences):
    ...
    counts = {result: 0 for _, result, _, _ in EV_RESULT_ROWS}
