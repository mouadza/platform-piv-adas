...
from admin_config.models import Gamme, GammeParsedData
from admin_config.services.gamme_parser import parse_gamme_cached
...
def schedule_gamme_parsing(gamme, *, force=False):
    ...
    def enqueue_task():
        from admin_config.tasks import parse_gamme_excel_task
