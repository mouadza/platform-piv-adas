...
from admin_config.models import CustomUser, Gamme, GammeParsedData, Projet
...
class GammeAsyncParseTests(APITestCase):
    ...
    @patch("admin_config.services.gamme_parse_storage.parse_gamme_cached")
    ...
    def test_parse_endpoint_queues_worker_when_json_is_missing(self):
        ...
        with patch("admin_config.tasks.parse_gamme_excel_task.delay") as delay:
