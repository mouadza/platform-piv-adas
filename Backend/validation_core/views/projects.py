...
from validation_core.models.vehicule import Vehicule
...
from validation_core.services.project_service import (
...
def createproject(request):
    try:
        projet = create_project_service(request.data, actor=request.user)
        log_audit_event(
            request=request,
...
def modifier_projet(request, projet_id):
    try:
        ...
        projet = update_project_service(projet_id, request.data, actor=request.user)
