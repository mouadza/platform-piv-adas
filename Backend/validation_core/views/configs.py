...
from validation_core.services.config_service import get_by_id, delete
from validation_core.models.config import (
    Role,
    Architecture,
    Motorisation,
    FonctionGamme,
...
from validation_core.serializers.config_serializers import (
    RoleSerializer,
