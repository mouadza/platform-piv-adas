...
from validation_core.models import Projet
from validation_core.models.config.type_procedure import TypeProcedure
from validation_core.models.config.fonction_gamme import FonctionGamme
